...
{
    public class GetOrderByOrderNumber : IGetOrderByOrderNumber
    {
        ...
        public GetOrderByOrderNumber(IOrderRepository orderRepository, IPaymentService paymentService, ICustomerService customerService, IProductService productService)
        {
